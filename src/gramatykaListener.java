...
public interface gramatykaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link gramatykaParser#columnConstraint}.
	 * @param ctx the parse tree
	 */
	void enterColumnConstraint(gramatykaParser.ColumnConstraintContext ctx);
	/**
	 * Exit a parse tree produced by {@link gramatykaParser#columnConstraint}.
	 * @param ctx the parse tree
	 */
	void exitColumnConstraint(gramatykaParser.ColumnConstraintContext ctx);
	/**
